...
<Section id="features-dataControl" color="#E6BE8A" title={`Step into control,<br><span class="highlight">say goodbye to data concerns.</span>`} description="Managing user feedback becomes daunting as your game expands. Existing systems struggle to scale, hindering collaboration and insight gathering. However with Atheria, you can seamlessly collect, organize, and analyze feedback in near real-time, fostering collaboration and driving improvement. Switch to Atheria to overcome organization challenges and unlock unlock new opportunities for your game." tags={["features"]}>
    <div class="scrollAnimation fromOpacity absolute right-0 top-1/2 h-full w-[87%] -translate-y-1/2">
        <div class="relative left-1/2 top-1/2 aspect-square h-[55%] -translate-x-1/2 -translate-y-1/2 [&>*]:absolute [&>*]:aspect-square [&>*]:w-24">
            ...
            <svg class="bottom-0 left-1/2 -translate-x-1/2 fill-[--sectionColor]" xmlns="http://www.w3.org/2000/svg" style="--rotation1: 0deg; --rotation2: 0deg; --delay: {Math.random() * 2}s;" viewBox="0 0 24 24">
            ...
            <div class="left-1/2 top-1/2 z-[-1] flex h-[60%] -translate-x-1/2 -translate-y-1/2 items-center justify-center gap-1">
                {#each Array(3) as _value}
                    <div class="wire relative h-full w-1.5 overflow-hidden rounded-md bg-slate-800">
                        <div class="pulse absolute h-full w-full rounded-md" style="background: linear-gradient(0deg, var(--sectionColor) 0%, var(--sectionShadowColor) 10%, var(--sectionColorFullyTransparent) 100%); --delay: {Math.random() * 2}s;" />
                    </div>
                {/each}
            </div>

            <div class="float left-0 top-1/2 -translate-y-1/2" style="--rotation1: 0deg; --rotation2: 0deg; --delay: {Math.random() * 2}s;">
                <svg class="h-full w-full fill-slate-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <svg class="absolute left-0 top-0 h-full w-full fill-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M5.47 5.47a.75.75 0 0 1 1.06 0L12 10.94l5.47-5.47a.75.75 0 1 1 1.06 1.06L13.06 12l5.47 5.47a.75.75 0 1 1-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 0 1-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" />
                </svg>
            </div>

            <div class="float right-0 top-1/2 -translate-y-1/2" style="--rotation1: 0deg; --rotation2: 0deg; --delay: {Math.random() * 2}s;">
                <svg class="h-full w-full fill-slate-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg class="absolute left-1/2 top-1/2 z-[1] aspect-square h-[20%] -translate-x-1/2 -translate-y-1/2 fill-[--sectionColor]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
